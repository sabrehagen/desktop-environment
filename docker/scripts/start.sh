...
docker run \
  ...
  --volume DESKTOP_ENVIRONMENT_CACHE_BRAVE:$DESKTOP_ENVIRONMENT_CACHE_BRAVE \
  ...
  --volume DESKTOP_ENVIRONMENT_STATE_BRAVE:$DESKTOP_ENVIRONMENT_STATE_BRAVE \
  ...
  --volume DESKTOP_ENVIRONMENT_STATE_FERDI:$DESKTOP_ENVIRONMENT_STATE_FERDI \
