...
docker run \
  ...
  --volume DESKTOP_ENVIRONMENT_CACHE_WINDSURF:$DESKTOP_ENVIRONMENT_CACHE_WINDSURF \
  ...
  --volume DESKTOP_ENVIRONMENT_STATE_WINDSURF:$DESKTOP_ENVIRONMENT_STATE_WINDSURF \
