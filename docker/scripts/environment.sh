...
DESKTOP_ENVIRONMENT_TTY=${DESKTOP_ENVIRONMENT_TTY-3}
...
echo export DESKTOP_ENVIRONMENT_STATE_CLAUDEAI=$DESKTOP_ENVIRONMENT_USER_HOME/.config/claudeai
...
echo export DESKTOP_ENVIRONMENT_STATE_WHATSDESK=$DESKTOP_ENVIRONMENT_USER_HOME/.config/whatsdesk
