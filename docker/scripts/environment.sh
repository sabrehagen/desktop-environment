...
DESKTOP_ENVIRONMENT_USER=${DESKTOP_ENVIRONMENT_USER-$DESKTOP_ENVIRONMENT_GITHUB_USER}
...
DESKTOP_ENVIRONMENT_CONTAINER_TAG=${DESKTOP_ENVIRONMENT_CONTAINER_TAG-$(git --git-dir $REPO_ROOT/.git rev-parse --abbrev-ref HEAD | tr / -)}
DESKTOP_ENVIRONMENT_GITHUB_TOKEN=${DESKTOP_ENVIRONMENT_GITHUB_TOKEN-}
DESKTOP_ENVIRONMENT_REGISTRY=${DESKTOP_ENVIRONMENT_REGISTRY-ghcr.io/$DESKTOP_ENVIRONMENT_GITHUB_USER}
