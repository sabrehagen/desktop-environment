...
DESKTOP_ENVIRONMENT_HOST_HOSTNAME=$HOSTNAME
DESKTOP_ENVIRONMENT_HOST_TTY=${DESKTOP_ENVIRONMENT_HOST_TTY:-4}
...
echo export DESKTOP_ENVIRONMENT_HOST_HOSTNAME=$DESKTOP_ENVIRONMENT_HOST_HOSTNAME
echo export DESKTOP_ENVIRONMENT_HOST_TTY=$DESKTOP_ENVIRONMENT_HOST_TTY
echo export DISPLAY=${DISPLAY:-:$DESKTOP_ENVIRONMENT_HOST_TTY}
